<template>
    <div>
      ...
      <m-btn class="btn green-l_txt">设置</m-btn>
      </div>
      ...
      <div style="width:220px;margin: 50px auto 10px" class="p-b16">
        <m-btn class="primary_bg grey-dark_txt bold" :data-text="item.url" :data-params="item.id" :sizeh="50" style="width: 100%;line-height: 50px;height: 50px">生成链接,分享邀请</m-btn>
      </div>
      <div class="share">
        <div class="box striped_bg over-hidden">
